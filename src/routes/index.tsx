    ...
    <div className="min-h-screen bg-soft-black font-sans selection:bg-champagne/30 overflow-x-hidden scroll-smooth">
      ...
      <div className="fixed bottom-8 right-0 md:right-8 z-50 flex flex-col items-end gap-4 pointer-events-none">
        ...
        <motion.a 
          ...
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="relative bg-champagne text-ivory px-10 py-5 rounded-full text-[10px] uppercase tracking-[0.4em] font-bold shadow-2xl hover:bg-muted-gold transition-colors scroll-mt-32 text-center"
        >
          Agendar valoración
        </motion.a>
      </div>
